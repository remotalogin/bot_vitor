...
exports.generateOdinId = exports.generateDeviceId = exports.generateSearchId = exports.randomChar = exports._getPlaylistParams = exports._getCollectionParams = exports._tiktokApiParams = exports._videoSearchParams = exports._liveSearchParams = exports._userSearchParams = exports._getCommentsParams = exports._xttParams = exports._getUserLikedParams = exports._getUserRepostsParams = exports._getUserPostsParams = void 0;
...
const _getUserRepostsParams = (secUid, cursor, count) => {
    return qs_1.default.stringify({
...
exports._getUserRepostsParams = _getUserRepostsParams;
...
const _getCollectionParams = (collectionId, page = 1, count = 5) => {
    let cursor = 0;
    if (page > 0) {
        cursor = (page - 1) * count;
    }
...
exports._getCollectionParams = _getCollectionParams;
const _getPlaylistParams = (playlistId, page = 1, count = 5) => {
...
exports._getPlaylistParams = _getPlaylistParams;
