...
async function obterDadosBrasileiraoA(rodadas = true) {
    try {
...
async function obterDadosBrasileiraoB(rodadas = true) {
    try {
...
exports.obterDadosBrasileiraoA = obterDadosBrasileiraoA;
exports.obterDadosBrasileiraoB = obterDadosBrasileiraoB;
