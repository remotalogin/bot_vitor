(function (global, factory) {
    ...
    function _reducePrecision(numString, precision) {
      ...
      var remainder = numString.slice(discountStartIndex); // string after erasing

      numString = numString.slice(0, discountStartIndex); // increment if needed by rounding mode
    ...
    function greaterThanFive(part, pre, neg, mode) {
      ...
      switch (mode) {
        ...
        default:
          return Number.parseInt(pre[pre.length - 1], 10) % 2 === 1;
      }
    }
    /**
     *
